...
// TestWriter_OverlappingTail pins the known difference from internal/redact:
// when one value's suffix is the next value's prefix, leftmost matching masks
// the first whole and leaves the second one's tail in the stream.
